...
namespace MessagePassingComm
{
    ...
    {
        static SWTools.BlockingQueue<CommMessage> rcvQ { get; set; } = null;
    ...
    public class TestPCommService
    {
        ...
        {
            Console.WriteLine("testing Sender & Receiver");
            bool test = true;
            ...
            if (!compareMsgs(sndMsg, rcvMsg))
                test = false;
            Console.WriteLine("sndMsg equals rcvMsg");
        ...
        {
            Console.WriteLine("testing Message-Passing Communication", '=');
            testSndrRcvr();
